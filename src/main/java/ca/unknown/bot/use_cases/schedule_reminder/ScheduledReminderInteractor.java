 ...
 * and is tasked with setting up direct message reminders (in progress).
 */
...
//        }
        ...
        if (event.getName().equals("schedule_event")) {
            ...
            // call subordinate interactor to schedule new generic event
            ...
            // call subordinate interactor to schedule new exam event
            ...
            // call subordinate interactor to schedule new assignment event
